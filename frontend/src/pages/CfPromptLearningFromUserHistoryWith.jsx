...
// Auto-generated page for: Prompt learning from user history with auto-completion

export default function CfPromptLearningFromUserHistoryWith() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-prompt-learning-from-user-history-with', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Prompt learning from user history with auto-completion</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Prompt learning from user history with auto-completion.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Prompt learning from user history with auto-completion'}
        </button>
      </form>
