...
// Auto-generated page for: Multimodal refinement combining reference images with natura

export default function CfMultimodalRefinementCombiningReferenc() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multimodal-refinement-combining-referenc', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Multimodal refinement combining reference images with natura</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Multimodal refinement combining reference images with natural-language change requests.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Multimodal refinement combining reference images with natura'}
        </button>
      </form>
