...
// Auto-generated page for: Batch generation + scheduling for weekly social-media conten

export default function CfBatchGenerationSchedulingForWeeklyS() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-batch-generation-scheduling-for-weekly-s', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Batch generation + scheduling for weekly social-media conten</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Batch generation + scheduling for weekly social-media content.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Batch generation + scheduling for weekly social-media conten'}
        </button>
      </form>
