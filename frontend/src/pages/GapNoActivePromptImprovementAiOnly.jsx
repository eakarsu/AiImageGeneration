...
// Auto-generated page for: No active prompt-improvement AI (only static optimizer)

export default function GapNoActivePromptImprovementAiOnly() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-active-prompt-improvement-ai-only', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No active prompt-improvement AI (only static optimizer)</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No active prompt-improvement AI (only static optimizer)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No active prompt-improvement AI (only static optimizer)'}
        </button>
      </form>
