...
// Auto-generated page for: Brand consistency guardrails enforcing uploaded brand guidel

export default function CfBrandConsistencyGuardrailsEnforcingU() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-brand-consistency-guardrails-enforcing-u', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Brand consistency guardrails enforcing uploaded brand guidel</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Brand consistency guardrails enforcing uploaded brand guidelines.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Brand consistency guardrails enforcing uploaded brand guidel'}
        </button>
      </form>
