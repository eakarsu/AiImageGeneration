...
// Auto-generated page for: No collaboration / shared workspaces

export default function GapNoCollaborationSharedWorkspaces() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-collaboration-shared-workspaces', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No collaboration / shared workspaces</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No collaboration / shared workspaces</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No collaboration / shared workspaces'}
        </button>
      </form>
