...
// Auto-generated page for: No public profile/portfolio pages

export default function GapNoPublicProfileportfolioPages() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-public-profileportfolio-pages', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No public profile/portfolio pages</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No public profile/portfolio pages</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No public profile/portfolio pages'}
        </button>
      </form>
